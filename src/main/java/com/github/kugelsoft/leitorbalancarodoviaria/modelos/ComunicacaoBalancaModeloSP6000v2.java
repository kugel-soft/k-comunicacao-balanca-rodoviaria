...
class ComunicacaoBalancaModeloSP6000v2 extends ComunicacaoBalanca {

	protected ComunicacaoBalancaModeloSP6000v2(ParametrosBalanca parametros) {
		super(parametros);
	}

	protected BigDecimal lerPesoModelo() throws IOException, PesoInvalidoException {
		String retorno = enviarComando(" ", 7);
