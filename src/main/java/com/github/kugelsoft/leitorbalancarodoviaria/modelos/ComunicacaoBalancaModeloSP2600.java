...
class ComunicacaoBalancaModeloSP2600 extends ComunicacaoBalanca {

	protected ComunicacaoBalancaModeloSP2600(ParametrosBalanca parametros) {
		super(parametros);
	}

	protected BigDecimal lerPesoModelo() throws IOException, PesoInvalidoException {
		String retorno = enviarComando(" ", 30);
